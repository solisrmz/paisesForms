...
//
//   const contryResponse = Convert.toContryResponse(json);
//
...
export class Convert {
    public static toContryResponse(json: string): CountryResponse[] {
        return cast(JSON.parse(json), a(r("ContryResponse")));
    }

    public static contryResponseToJson(value: CountryResponse[]): string {
        return JSON.stringify(uncast(value, a(r("ContryResponse"))), null, 2);
    }
}
